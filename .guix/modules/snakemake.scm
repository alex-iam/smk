...
(define-public snakemake
 ...
 (name "snakemake")
 (version "0.1.0")
 (source (local-file "../.." "snakemake-checkout"
                      #:recursive? #t
 ...
 (description "Snakemake is a dead simple build script for C/C++. It supports singe-executable builds only. Incremental and parallel builds are supported. Can detect system libraries as dependencies.")
 (home-page "https://github.com/alex-iam/snakemake")
 (license gpl3+)))
snakemake
